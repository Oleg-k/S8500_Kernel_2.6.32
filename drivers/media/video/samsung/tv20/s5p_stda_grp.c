...
{
        struct s5ptvfb_window *win = fb->par;
        struct fb_var_screeninfo st_var = (struct fb_var_screeninfo)s5ptv_status.fb->var;
        struct fb_var_screeninfo in_var = (struct fb_var_screeninfo)fb->var;
        ...
        st_var.bits_per_pixel = in_var.bits_per_pixel;
