...
static unsigned int jupiter_gpio_table[][6] =
{
	...
	{S5PV210_GPB(1),  S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST},	// MSENSE_nRST 
#else
...
#if defined(CONFIG_ARIES_LATONA)
	{S5PV210_GPJ3(2), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST},	// LED_EN1
	{S5PV210_GPJ3(3), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 	// LED_EN2
#else
...
//#endif
	...
	{S5PV210_MP05(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},	//FUEL_SDA_18V
...
//	off part GPIO Sleep Control table
//	{pin number,	  sleep mode conf,	  sleep pullup/down config}
static unsigned int latona_sleep_gpio_table_rev07[][3] =
{
	// GPA0 -------------------------------------------------
	{S5PV210_GPA0(0), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_BT_UART_RXD
	{S5PV210_GPA0(1), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_BT_UART_TXD
	...
	// MP01 -------------------------------------------------
	{S5PV210_MP01(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_MP010
#if defined(CONFIG_ARIES_LATONA)  // Latona Rev07 ~
